...
export const metadata: Metadata = {
    ...
    description:
        "Distribute Amapiano music to 450+ stores worldwide. Save 30% on US Tax. Keep 100% of your masters. Get funded up to $5M. The #1 distributor for Amapiano artists.",
};
