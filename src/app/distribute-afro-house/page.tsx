...
export const metadata: Metadata = {
    ...
    description:
        "Distribute Afro House music to 450+ stores worldwide. Save 30% on US Tax. Keep 100% of your masters. Get funded up to $10M+ via the Sovereign Capital Vault. The #1 distributor for Afro House artists.",
};
