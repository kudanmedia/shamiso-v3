...
export const metadata: Metadata = {
    ...
    description:
        "Distribute Lekompo music to 450+ stores worldwide. Save 30% on US Tax. Keep 100% of your masters. Get funded up to $10M+. The #1 distributor for Lekompo artists.",
};
