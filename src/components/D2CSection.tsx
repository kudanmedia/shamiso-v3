...
const d2cFeatures = [
    {
        ...
        description: "Unlike traditional streaming platforms that hide your audience, our D2C engine puts you in control. See every fan, collect every email, and own your relationship.",
        icon: Users,
    ...
    },
    {
        ...
        description: "Why wait months for royalty statements? With Shamiso D2C, your fans pay you today, and you can withdraw your profits within the same week.",
        icon: Clock,
        color: "text-blue-400",
        ...
        <section className="relative py-24 bg-black overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-3xl text-lg text-neutral-400 leading-relaxed font-light">
                        The era of being a middleman is over. Transition to a Direct-To-Consumer powerhouse
                        and monetize your cult following before the global release.
                    </p>
                </div>
                    ...
                    <div className="grid gap-12 lg:grid-cols-2 items-center">
                        <div>
                            <h3 className="text-2xl font-black text-white uppercase mb-4">
                                Sell for <span className="text-shamiso-gold-bright">R180</span>, Not $0.003
                            </h3>
                            <p className="text-neutral-400 mb-8 leading-relaxed">
                                Traditional distribution fights over micro-cents. Our D2C engine lets you sell a digital
                                collector&apos;s edition directly to your super-fans for the price of a real album.
                                One R180 sale is worth more than 3,000 streams.
                            </p>
                        ...
                        <div className="glass-card rounded-2xl border border-white/10 p-6 shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-between mb-8">
                                <p className="text-xs font-bold text-white uppercase tracking-widest">D2C Engine: Live Analytics</p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                    ...
                                    <p className="text-xl font-bold text-white">R24,850.00</p>
                                </div>
                                <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                            ...
                            <div className="space-y-3">
                                ...
                                {[
                                    { name: "Thabo M.", item: "Digital Deluxe", time: "2m ago", price: "R180" },
                                    { name: "Lerato K.", item: "Early Release LP", time: "15m ago", price: "R250" },
                                    { name: "Sizwe D.", item: "Exclusive Bundle", time: "42m ago", price: "R450" }
                                ].map((order, i) => (
