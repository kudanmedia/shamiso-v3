...
const services = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                name: "TOORLY Touring",
                description: "Fan-demand driven touring platform to book shows with certainty.",
                icon: MapPin,
                href: "/signup",
                color: "text-shamiso-gold-bright",
                borderColor: "border-shamiso-gold/20 hover:border-shamiso-gold/50",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                description: "Professional wealth management and tax optimization.",
                icon: Headphones,
                href: "/signup",
                color: "text-shamiso-gold-bright",
                borderColor: "border-shamiso-gold/20 hover:border-shamiso-gold/50",
